...
mainTl.add(starTl, 0)
gsap.globalTimeline.timeScale(5);    //  圣诞树开始绘画时小光点动画的绘画速率，越大越快

setTimeout( function(){
var element = document.getElementById("header");
element.innerHTML = "圣诞快乐 copy from csdn ";
...
element.innerHTML = " 会写网页dd（我不会写） ";
var element = document.getElementById("p1");
element.innerHTML = " <br />  表情";
